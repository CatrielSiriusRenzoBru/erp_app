<div class="salaryBands view">
<h2><?php echo __('Salary Band'); ?></h2>
	<dl>
		<dt><?php echo __('Id'); ?></dt>
		<dd>
			<?php echo h($salaryBand['SalaryBand']['id']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Title'); ?></dt>
		<dd>
			<?php echo h($salaryBand['SalaryBand']['title']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Band Min'); ?></dt>
		<dd>
			<?php echo h($salaryBand['SalaryBand']['band_min']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Band Max'); ?></dt>
		<dd>
			<?php echo h($salaryBand['SalaryBand']['band_max']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Created'); ?></dt>
		<dd>
			<?php echo h($salaryBand['SalaryBand']['created']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Created By'); ?></dt>
		<dd>
			<?php echo h($salaryBand['SalaryBand']['created_by']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Modified'); ?></dt>
		<dd>
			<?php echo h($salaryBand['SalaryBand']['modified']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Modified By'); ?></dt>
		<dd>
			<?php echo h($salaryBand['SalaryBand']['modified_by']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Deleted'); ?></dt>
		<dd>
			<?php echo h($salaryBand['SalaryBand']['deleted']); ?>
			&nbsp;
		</dd>
	</dl>
</div>
<div class="actions">
	...
	<ul>
		<li><?php echo $this->Html->link(__('Edit Salary Band'), array('action' => 'edit', $salaryBand['SalaryBand']['id'])); ?> </li>
		<li><?php echo $this->Form->postLink(__('Delete Salary Band'), array('action' => 'delete', $salaryBand['SalaryBand']['id']), array(), __('Are you sure you want to delete # %s?', $salaryBand['SalaryBand']['id'])); ?> </li>
		<li><?php echo $this->Html->link(__('List Salary Bands'), array('action' => 'index')); ?> </li>
		<li><?php echo $this->Html->link(__('New Salary Band'), array('action' => 'add')); ?> </li>
...
<div class="related">
	...
	<?php if (!empty($salaryBand['Employee'])): ?>
	...
	<?php foreach ($salaryBand['Employee'] as $employee): ?>
		<tr>
...
<div class="related">
	...
	<?php if (!empty($salaryBand['Salary'])): ?>
	<table cellpadding = "0" cellspacing = "0">
	<tr>
		<th><?php echo __('Id'); ?></th>
		<th><?php echo __('Title'); ?></th>
		<th><?php echo __('Employee Id'); ?></th>
		<th><?php echo __('Base Salary'); ?></th>
		<th><?php echo __('Salary Band Id'); ?></th>
		<th><?php echo __('Created'); ?></th>
		<th><?php echo __('Created By'); ?></th>
		<th><?php echo __('Modified'); ?></th>
	...
	<?php foreach ($salaryBand['Salary'] as $salary): ?>
		<tr>
			<td><?php echo $salary['id']; ?></td>
			<td><?php echo $salary['title']; ?></td>
			<td><?php echo $salary['employee_id']; ?></td>
			<td><?php echo $salary['base_salary']; ?></td>
			<td><?php echo $salary['salary_band_id']; ?></td>
			<td><?php echo $salary['created']; ?></td>
			<td><?php echo $salary['created_by']; ?></td>
			<td><?php echo $salary['modified']; ?></td>
			<td><?php echo $salary['modified_by']; ?></td>
			<td><?php echo $salary['deleted']; ?></td>
			<td class="actions">
				...
				<?php echo $this->Form->postLink(__('Delete'), array('controller' => 'salaries', 'action' => 'delete', $salary['id']), array(), __('Are you sure you want to delete # %s?', $salary['id'])); ?>
			</td>
		</tr>
	<?php endforeach; ?>
	</table>
