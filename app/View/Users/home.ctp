<?php 
$this->Html->css('assets/css/main','stylesheet', array('inline' => false ) );
$this->Html->script('assets/gauge', array('block' => 'scriptBottom') );
$this->Html->script('assets/dash-charts', array('block' => 'scriptBottom') );
$this->Html->script('http://code.highcharts.com/highcharts.js', array('block' => 'scriptBottom') );
$this->Html->script('assets/jquery.flexslider', array('block' => 'scriptBottom') );
$this->Html->script('assets/admin', array('block' => 'scriptBottom') );
$this->Html->script('assets/lineandbars', array('block' => 'scriptBottom') );
?>
...
<!--        <div class="col-sm-3 col-lg-3">
      		<div class="dash-unit">
				...
				<h1>Emmanuel Mawunyo Awoonor</h1>
				<h3>Londong, UK</h3>
				<br>
					<div class="info-user">
      ...
      <!-- SERVER UPTIME -->
			<div class="half-unit">
	      		...
	      		<hr>
	      		<div class="cont">
					<p><img src="webroot/css/assets/img/up.png" alt=""> <bold>Up</bold> | 356ms.</p>
				</div>
			</div>
