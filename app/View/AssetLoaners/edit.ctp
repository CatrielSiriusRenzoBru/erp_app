...
<?php echo $this->Form->create('AssetLoaner'); ?>
	<fieldset>
		<legend><?php echo __('Edit Asset Loaner'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('AssetLoaner.id')), array(), __('Are you sure you want to delete # %s?', $this->Form->value('AssetLoaner.id'))); ?></li>
