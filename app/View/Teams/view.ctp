...
<h2><?php echo __('Team'); ?></h2>
	<dl>
		...
		<dd>
			<?php echo h($team['Team']['modified_by']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Deleted'); ?></dt>
		<dd>
			<?php echo h($team['Team']['deleted']); ?>
			&nbsp;
		</dd>
	</dl>
</div>
...
<div class="related">
	<h3><?php echo __('Related Cost Centres'); ?></h3>
	<?php if (!empty($team['CostCentre'])): ?>
	...
	<?php foreach ($team['CostCentre'] as $costCentre): ?>
		<tr>
			<td><?php echo $costCentre['id']; ?></td>
			<td><?php echo $costCentre['title']; ?></td>
			<td><?php echo $costCentre['team_id']; ?></td>
			<td><?php echo $costCentre['created']; ?></td>
			<td><?php echo $costCentre['created_by']; ?></td>
			<td><?php echo $costCentre['modified']; ?></td>
			<td><?php echo $costCentre['modified_by']; ?></td>
			<td><?php echo $costCentre['deleted']; ?></td>
			<td class="actions">
				<?php echo $this->Html->link(__('View'), array('controller' => 'cost_centres', 'action' => 'view', $costCentre['id'])); ?>
				<?php echo $this->Html->link(__('Edit'), array('controller' => 'cost_centres', 'action' => 'edit', $costCentre['id'])); ?>
				<?php echo $this->Form->postLink(__('Delete'), array('controller' => 'cost_centres', 'action' => 'delete', $costCentre['id']), array(), __('Are you sure you want to delete # %s?', $costCentre['id'])); ?>
			</td>
		</tr>
	<?php endforeach; ?>
	</table>
