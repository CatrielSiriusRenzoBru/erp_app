<div class="employeeStatuses view">
<h2><?php echo __('Employee Status'); ?></h2>
	<dl>
		<dt><?php echo __('Id'); ?></dt>
		<dd>
			<?php echo h($employeeStatus['EmployeeStatus']['id']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Title'); ?></dt>
		<dd>
			<?php echo h($employeeStatus['EmployeeStatus']['title']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Created'); ?></dt>
		<dd>
			<?php echo h($employeeStatus['EmployeeStatus']['created']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Created By'); ?></dt>
		<dd>
			<?php echo h($employeeStatus['EmployeeStatus']['created_by']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Modified'); ?></dt>
		<dd>
			<?php echo h($employeeStatus['EmployeeStatus']['modified']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Modified By'); ?></dt>
		<dd>
			<?php echo h($employeeStatus['EmployeeStatus']['modified_by']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Deleted'); ?></dt>
		<dd>
			<?php echo h($employeeStatus['EmployeeStatus']['deleted']); ?>
			&nbsp;
		</dd>
	</dl>
</div>
<div class="actions">
	...
	<ul>
		<li><?php echo $this->Html->link(__('Edit Employee Status'), array('action' => 'edit', $employeeStatus['EmployeeStatus']['id'])); ?> </li>
		<li><?php echo $this->Form->postLink(__('Delete Employee Status'), array('action' => 'delete', $employeeStatus['EmployeeStatus']['id']), array(), __('Are you sure you want to delete # %s?', $employeeStatus['EmployeeStatus']['id'])); ?> </li>
		<li><?php echo $this->Html->link(__('List Employee Statuses'), array('action' => 'index')); ?> </li>
		<li><?php echo $this->Html->link(__('New Employee Status'), array('action' => 'add')); ?> </li>
...
<div class="related">
	...
	<?php if (!empty($employeeStatus['Employee'])): ?>
	...
	<?php foreach ($employeeStatus['Employee'] as $employee): ?>
		<tr>
