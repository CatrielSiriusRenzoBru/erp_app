...
<h2><?php echo __('Ethnicity'); ?></h2>
	<dl>
		...
		<dd>
			<?php echo h($ethnicity['Ethnicity']['title']); ?>
			&nbsp;
		</dd>
		...
		<dd>
			<?php echo h($ethnicity['Ethnicity']['created_by']); ?>
			&nbsp;
		</dd>
		...
		<dd>
			<?php echo h($ethnicity['Ethnicity']['modified_by']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Deleted'); ?></dt>
		<dd>
			<?php echo h($ethnicity['Ethnicity']['deleted']); ?>
			&nbsp;
		</dd>
	</dl>
</div>
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete Ethnicity'), array('action' => 'delete', $ethnicity['Ethnicity']['id']), array(), __('Are you sure you want to delete # %s?', $ethnicity['Ethnicity']['id'])); ?> </li>
...
<div class="related">
	...
	<?php if (!empty($ethnicity['Employee'])): ?>
	...
	<?php foreach ($ethnicity['Employee'] as $employee): ?>
		<tr>
