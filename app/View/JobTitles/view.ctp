...
<h2><?php echo __('Job Title'); ?></h2>
	<dl>
		...
		<dd>
			<?php echo h($jobTitle['JobTitle']['title']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Created'); ?></dt>
		<dd>
			<?php echo h($jobTitle['JobTitle']['created']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Created By'); ?></dt>
		<dd>
			<?php echo h($jobTitle['JobTitle']['created_by']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Modified'); ?></dt>
		<dd>
			<?php echo h($jobTitle['JobTitle']['modified']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Modified By'); ?></dt>
		<dd>
			<?php echo h($jobTitle['JobTitle']['modified_by']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Deleted'); ?></dt>
		<dd>
			<?php echo h($jobTitle['JobTitle']['deleted']); ?>
			&nbsp;
		</dd>
	</dl>
</div>
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete Job Title'), array('action' => 'delete', $jobTitle['JobTitle']['id']), array(), __('Are you sure you want to delete # %s?', $jobTitle['JobTitle']['id'])); ?> </li>
