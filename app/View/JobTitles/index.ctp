<div class="jobTitles index">
	...
	<tr>
		<td><?php echo h($jobTitle['JobTitle']['id']); ?>&nbsp;</td>
		<td><?php echo h($jobTitle['JobTitle']['title']); ?>&nbsp;</td>
		<td><?php echo h($jobTitle['JobTitle']['created']); ?>&nbsp;</td>
		<td><?php echo h($jobTitle['JobTitle']['created_by']); ?>&nbsp;</td>
		<td><?php echo h($jobTitle['JobTitle']['modified']); ?>&nbsp;</td>
		<td><?php echo h($jobTitle['JobTitle']['modified_by']); ?>&nbsp;</td>
		<td><?php echo h($jobTitle['JobTitle']['deleted']); ?>&nbsp;</td>
		<td class="actions">
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Html->link(__('List Employees'), array('controller' => 'employees', 'action' => 'home')); ?> </li>
