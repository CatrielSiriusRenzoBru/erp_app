<div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title"><?php echo __('Edit Emergency Contact'); ?></h4>
        
      </div>
<?php echo $this->Form->create('EmergencyContact', array("controller" => "emergencycontacts", "action"=>"edit", "class"=>"form-horizontal")); ?>
	...
	<?php
		...
		echo $this->Form->input('employee_id', array('type'=>'hidden', 'value'=>$this->request->data['EmergencyContact']['employee_id']));
