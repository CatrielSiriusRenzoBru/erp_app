...
<?php echo $this->Form->create('Payroll'); ?>
	<fieldset>
		<legend><?php echo __('Edit Payroll'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Payroll.id')), array(), __('Are you sure you want to delete # %s?', $this->Form->value('Payroll.id'))); ?></li>
